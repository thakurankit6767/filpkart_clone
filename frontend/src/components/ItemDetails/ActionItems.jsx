...
const ActionItem = ({ data }) => {
    ...
    const { id, price, images, title } = data;
    ...
    return (
        <Box className={classes.leftContainer}>
            <img src={data.images} className={classes.productImage} alt="" /><br />
            <Button onClick={() => addItemToCart()} className={clsx(classes.button, classes.addCart)} style={{marginRight: 10}} variant="contained"><Cart />Add to Cart</Button>
